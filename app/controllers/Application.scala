...
case class Tweet(id_str: String, created_at: String, usr_name: String, text: String, concepts: List[String] )
object Application extends Controller {
  ...
  def ws = WebSocket.using[JsValue] { request =>
    ...
    val t = Tweet("81979798765", "Wed Aug 27 13:08:45 +0000 2008", "laem", 
        "La voie pour l'avenir de l'humanité", List("La Voie", "Edgar Morin"))
